  ...
  return (
    <Dialog size='xs' open={open}>
      <DialogHeader className='flex justify-center'>
        <span className='text-lg text-blue-gray-800'>Security Alert!</span>
      </DialogHeader>
      <DialogBody className='flex flex-col items-center'>
        <LockClosedIcon color='red' className='w-20 h-20' />
        <span className='text-sm font-normal text-blue-gray-700'>Please change your password.</span>
      </DialogBody>
      <DialogFooter>
        <Button color='green' variant="outlined" fullWidth onClick={onClick}>
